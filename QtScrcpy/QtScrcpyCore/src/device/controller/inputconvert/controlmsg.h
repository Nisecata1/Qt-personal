...
public:
    enum ControlMsgType
    {
        ...
        CMT_ROTATE_DEVICE,
        CMT_INJECT_CURSOR = 0x80,
        CMT_SET_CURSOR_CONFIG = 0x81
    };
    ...
    // action 常用的是AMOTION_EVENT_ACTION_DOWN，AMOTION_EVENT_ACTION_UP，AMOTION_EVENT_ACTION_MOVE；
    // 普通模式远端鼠标兼容分支还会用AMOTION_EVENT_ACTION_HOVER_MOVE。
    ...
    void setInjectCursorMsgData(qint32 x, qint32 y, qint32 w, qint32 h);
    void setCursorConfigMsgData(qint32 cursorSizePx);
