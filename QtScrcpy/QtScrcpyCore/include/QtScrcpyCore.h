...
public:
    ...
    virtual void updateBitRate(quint64 bitRate) { Q_UNUSED(bitRate); }
    ...
    virtual void setDeviceClipboardText(QString &text, bool paste = true) { Q_UNUSED(text); Q_UNUSED(paste); }
...
signals:
    void deviceConnected(bool success, const QString& serial, const QString& deviceName, const QSize& size, int initialOrientation = -1);
    void deviceDisconnected(QString serial);
    void recordingStateChanged(const QString &serial, bool active, const QString &filePath);
    void recordingError(const QString &serial, const QString &message);
...
public:
    ...
    virtual void setDeviceClipboardText(QString &text, bool paste = true) = 0;
    ...
    virtual bool startRecording(const QString &recordDir, const QString &recordFileFormat, QString *errorOut = nullptr) = 0;
